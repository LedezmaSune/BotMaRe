 ...
 * Configurable por variable de entorno RATE_LIMIT_MAX (por defecto 10000 peticiones / 15 minutos).
 */
export const globalLimiter = rateLimit({
    windowMs: 15 * 60 * 1000, // 15 minutos
    max: process.env.RATE_LIMIT_MAX ? parseInt(process.env.RATE_LIMIT_MAX, 10) : 10000,
